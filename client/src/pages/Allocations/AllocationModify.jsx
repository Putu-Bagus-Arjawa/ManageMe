...
const AllocationModify = () => {
    ...
    try {
      const res = await fetch(`http://localhost:9000/allocation/modify/${day}`, {
        method: "PUT",
        headers: {
      ...
      useEffect(() => {
        ...
        try {
            const res = await fetch(`http://localhost:9000/allocation/${day}`, {
            method: "GET",
            credentials: "include"
            })
                ...
                <Form submitting={handleSubmit}>
                    <div className="h-full w-full flex flex-col items-center justify-center">
                        <div className="flex flex-col mb-4">
                            <h1 className="font-insan text-3xl text-center">Alokasi Anggaran</h1>
...
export default AllocationModify
