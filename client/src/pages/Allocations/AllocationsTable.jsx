...
const AllocationTableRow = ({ day, items, price, exp, allocation_status}) => {
  ...
  return (
    <tr className={`border-b border-green-200 hover:bg-gray-100 ${rowBg}`}>
      ...
      <td className="py-3 px-6 text-center">
       <Link
          to={allocation_status == "Unfinished"? `/allocation/status/${day}`: ""}
      ...
      <td>
        <Link to={`/allocation/modify/${day}`} className="hover:text-amber-400">
            <Pencil/>
        </Link>
        </td>
    </tr>
